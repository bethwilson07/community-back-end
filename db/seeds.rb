...
barney = Member.create(name: "Barney Stinson", age: 34 , email: "barney@hmail.com", photo: "https://www.sheknows.com/wp-content/uploads/2018/08/NPH-Barney_komvse.jpeg", bio: "Suit up! It's going to be--wait for it--....lengendary!", group: himym )
robin = Member.create(name: "Robin Scherbatsky", age: 42, email:"robin@hmail.com", photo: "https://www.sheknows.com/wp-content/uploads/2018/08/himym-robin-sparkes-ps-i-love-you_o6zyc6.jpeg", bio: "Let's go to the mall, eh?", group: himym )
marshall = Member.create(name: "Marshall Eriksen", age: 28, email:"marshall@hmail.com", photo: "https://thepostculture.files.wordpress.com/2014/03/daisy.png", bio: "College, Ted, Lily, Law School, Drinks, Hockey.", group: himym )
lily = Member.create(name: "Lily Aldrin", age: 32, email:"lily@hmail.com", photo: "https://upload.wikimedia.org/wikipedia/en/f/fe/Lily_aldrin.jpg", bio: "I looooooooove people and my friends and especially Marshall.", group: himym )
...
catch_up = Event.create(name: "Catch up @ the Bar", description: "Ted's Birthday. Maybe he'll find his soul mate.", location: "MacLaren's Pub", :when => DateTime.strptime("02/02/2019 18:30", "%m/%d/%Y %H:%M"), group: himym)
