...
bar_hangout = Event.create(name: "Hangout @ the Bar", photo: "https://img.thedailybeast.com/image/upload/c_crop,d_placeholder_euli9k,h_1439,w_2560,x_0,y_0/dpr_2.0/c_limit,w_740/fl_lossy,q_auto/v1492201523/articles/2014/03/31/everything-you-need-to-know-about-how-i-met-your-mother/comic-con-2013-how-i-met-your-mother_ikwie7", description: "Hangout at our bar.", location: "MacLaren's Pub", :when => DateTime.strptime("01/14/2019 19:30", "%m/%d/%Y %H:%M"), group: himym)
teds_birthday = Event.create(name: "Ted's Birthday", photo: "https://pixel.nymag.com/imgs/daily/vulture/2017/11/07/07-himym.w1200.h630.jpg", description: "Celebrating Ted!", location: "MacLaren's Pub", :when => DateTime.strptime("02/02/2019 18:30", "%m/%d/%Y %H:%M"), group: himym)
shenanigans = Event.create(name: "Hangout @ Marshall's Apt", photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTo0EL_JhvIxwENKVabapnwWY9utOTeF78p8AqUrdBI_Vpnjda15Q", description: "Hanging out at Marshall & Lily's place.", location: "Marshall & Lily's Apt", :when => DateTime.strptime("01/12/2019 14:30", "%m/%d/%Y %H:%M"), group: himym)
dinner = Event.create(name: "Dinner @ the Bar", photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGkQuxtaBVmV1ej-2P5WE5kjDaZnuqDIOGHH7m5UJDjXE-bBUp4A", description: "Dinner @ the Bar", location: "MacLaren's Pub", :when => DateTime.strptime("01/08/2019 19:00", "%m/%d/%Y %H:%M"), group: himym)
talking = Event.create(name: "Hangout @ Ted's Apt", photo:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKPt3QAfTntIsRJjaVVTg89dOoZszNDPlGfiQn9ZxbMmRkQOaoSg", description: "Emotional discussions at Ted's place.", location:"Ted's Apt", :when => DateTime.strptime("01/11/2019 20:00", "%m/%d/%Y %H:%M"), group: himym)
